...
import { FaCartPlus, FaCapsules } from "react-icons/fa";
...
const OurServices = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      title: "Organ Banks",
      description:
        "Hope for a second chance—connect with potential organ donors and find the gift of life",
    ...
    },
    {
      ...
      title: "Blood Banks",
      description:
        "Urgently need blood? Find donors and receive the gift of life.",
    ...
    },
    {
      ...
      description:
        "Need medical equipment? Find rentals for your healthcare needs easily.",
    ...
    },
    {
      ...
      description:
        "Looking for an appointment? Find and book a doctor hassle-free",
    ...
    },
    {
      ...
      description:
        "Need a lab test? Search and book lab tests easily from trusted labs",
      path: user ? `/${userName}/labs-filter` : "/login",
    },
    {
      icon: <FaCapsules />, // Replace with an appropriate pharmacy-related icon
      title: "Pharmacy Services",
      description:
        "Search for nearby pharmacies, view available medicines, and place orders for your prescriptions with ease. Simplify your medication management today.",
      path: "/pharmacies",
    },
  ];
  ...
  return (
    <div className="services-container">
      <h1>Our services</h1>
      <p>
        Upload prescriptions and health attributes for a complete digital health
        record. Set reminders for appointments and medications, and regularly
        review your documents for accurate, up-to-date information.
      </p>
