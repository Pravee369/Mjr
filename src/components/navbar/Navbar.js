...
import { pharmaStore } from "../pharmacies/PharmacyStore";
import PharmacyNavbar from "../pharmacies/PharmacyNav";
  ...
  useEffect(() => {
    if (currentUser) {
      if (currentUser.photo) {
        ...
        currentUser.organizationType !== "Pharmacy"
      ) {
          ...
          <ul className="navbar-nav ms-auto mb-0 mb-lg-0">
            {userLoginStatus === false ? (
              ...
              <>
                <li className="nav-item">
                  <NavLink
                    className="nav-link active chakra-petch-regular nav-bar-button"
                    to="/"
                    style={({ isActive }) =>
                      isActive ? activeLink : inactiveLink
                    }
                ...
                {currentUser.category === "Doctor" && (
                  <li>
                    <NavLink
                      className="nav-link chakra-petch-regular nav-bar-button"
                      to="/appointments"
                      style={({ isActive }) =>
                        isActive ? activeLink : inactiveLink
                      }
                ...
                {currentUser.category === "Organization" &&
                  currentUser.organizationType === "Organ Bank" && (
                    <li>
                      <NavLink
                        className="nav-link chakra-petch-regular nav-bar-button"
                ...
                {currentUser.category === "Organization" &&
                  currentUser.organizationType === "Blood Bank" && (
                    <li>
                      <NavLink
                        className="nav-link chakra-petch-regular nav-bar-button"
                ...
                {currentUser.category === "Organization" &&
                  currentUser.organizationType === "Equipment Renter" && (
                    <li>
                      <NavLink
                        className="nav-link chakra-petch-regular nav-bar-button"
                  ...
                  >
                    ...
                    {currentUser.category === "Doctor" && (
                      <li>
                        <button
                          className="dropdown-item"
                          onClick={() => toggleModal("getVerified")}
                        >
                          Get Verified
                        </button>
                      </li>
                    ...
                    {currentUser.category === "Organization" &&
                      currentUser.organizationType === "Hospital" && (
                        <li>
                          <NavLink
                            className="dropdown-item"
                            to={`Organization/Hospital/${userName}/verifications`}
                          >
                            Verifications
                          </NavLink>
                        </li>
                    ...
                    {currentUser.category === "Organization" &&
                      currentUser.organizationType === "Laboratory" && (
                        <li>
                          <NavLink
                            className="dropdown-item"
                            to={`Organization/Laboratory/${userName}/dashboard`}
                          >
                            Dashboard
                          </NavLink>
                        </li>
                      )}
                    {currentUser && currentUser.category === "Organization" &&
                      currentUser.organizationType === "Pharmacy" && (
                        <li>
                          <NavLink
                            className="dropdown-item"
                            to={`Organization/pharmacies/${userName}/dashboard`}
                          >
                            Dashboard
                          </NavLink>
                        </li>
