...
import "./BloodBanksApproval.css";
import { CgProfile } from "react-icons/cg";
import { loginContext } from "../../../contexts/loginContext";
import { NavLink } from "react-router-dom";
import axios from "axios";

function BloodBanksPending() {
  ...
  let acceptReq = (RequestObj) => {
    ...
    updatedObj["quantity"] = RequestObj.quantity;
    ...
    axios
      .put(
            `http://localhost:3000/blood-banks/update-blood-request/${temp}`,
        updatedObj,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="bloodOrg mt-5" style={{ width: "100%" }}>
      <div
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <b>
                Are you sure the specified blood type and quantity are
                available?
              </b>
            </div>
...
export default BloodBanksPending;
