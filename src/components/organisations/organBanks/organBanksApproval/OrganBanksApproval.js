...
import "./OrganBanksApproval.css";
import { CgProfile } from "react-icons/cg";
import { loginContext } from "../../../contexts/loginContext";
import { NavLink } from "react-router-dom";
import axios from "axios";

function OrganBanksApproval() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:3000/organ-banks/get-required-organ", {
        headers: {
  ...
  let acceptReq = (RequestObj) => {
    ...
    updatedObj["organRequired"] = RequestObj.organRequired;
    updatedObj["bloodGroup"] = RequestObj.bloodGroup;
    ...
    axios
      .put(
            `http://localhost:3000/organ-banks/update-organ-request/${temp}`,
        updatedObj,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="OrganOrg" style={{ width: "100%" }}>
      <div
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <b>
                Are you sure the specified organ of the given blood type is 
                available?
              </b>
            </div>
            ...
            return (
              <div className="col-4 mt-3">
                <div className="card" style={{ width: "100%" }}>
                  ...
                  >
                    <b>{curObj.organRequired} ({curObj.bloodGroup})</b>
                  </h5>
            ...
            return (
              <div className="col-4 mt-3">
                <div className="card" style={{ width: "100%" }}>
                  ...
                  >
                    {curObj.organRequired} ({curObj.bloodGroup})
                  </h5>
                  <div className="card-body">
                    <h6 className="card-subtitle mb-2 ">
                      <b>Name : </b> {curObj.patientName}
...
export default OrganBanksApproval;